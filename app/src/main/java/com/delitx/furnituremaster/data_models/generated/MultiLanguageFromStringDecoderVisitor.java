...
public interface MultiLanguageFromStringDecoderVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code exprValueFinal}
	 * labeled alternative in {@link MultiLanguageFromStringDecoderParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprValueFinal(MultiLanguageFromStringDecoderParser.ExprValueFinalContext ctx);
	/**
	 * Visit a parse tree produced by the {@code exprValueWord}
	 * labeled alternative in {@link MultiLanguageFromStringDecoderParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprValueWord(MultiLanguageFromStringDecoderParser.ExprValueWordContext ctx);
	/**
